...
function Mainscreen() {
  ...
  const back = <Link to='/d2r-ladder-items/runewords-ladder/' className='btn btn-dark my-3'>Go Back</Link>

  const filtered = products.filter(product => {
    return product.category === "runewords shields";
  });
